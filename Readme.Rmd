...
\begin{equation}
\begin{split}
& x_i = \left(\frac{t_i}{\tau_0}\right)^\beta \\
&y_i =\frac{f(t_i)-f_\infty}{1-f_\infty}{\rm e}^{-(t_i/\tau_0)^\beta}  
\end{split}
\end{equation}
Note that the predictors ($\beta,\,\tau_0,\, f_\infty$) are different for each decay curve, labelled by the game id. Below we show the result of this transformation: 
