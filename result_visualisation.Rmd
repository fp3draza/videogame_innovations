...
game_degree_plot <- ggplot(data = game_network_clean_data, aes(x =  as.numeric(degree))) + geom_histogram(color = 'black', alpha = 0.6) + theme_minimal() + xlab('Degree') + ylab('Frequency') + ggtitle('Player Degree Distribution')  + theme(aspect.ratio = 1)
